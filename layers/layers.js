...
lyr_output_shapefile_1.set('fieldLabels', {'PlotID': 'header label - always visible', 'ID': 'header label - always visible', 'Plot': 'header label - always visible', 'Block': 'header label - always visible', 'Row': 'header label - always visible', 'Range': 'header label - always visible', 'Weight': 'header label - always visible', 'Height': 'header label - always visible', 'Maturity': 'header label - always visible', 'Yield': 'header label - always visible', 'TuberSet': 'header label - always visible', });
